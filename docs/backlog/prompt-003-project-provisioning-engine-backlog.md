...
| ID | Item | Status | ADR | Acceptance Criteria |
| --- | --- | --- | --- | --- |
| P3-201 | Add PostGIS execution adapter | Planned | ADR-0008, ADR-0017 | Engine creates or validates physical PostGIS database/schema through a tested adapter. |
| P3-202 | Add NAS execution adapter | Planned | ADR-0007, ADR-0017 | Engine creates or validates NAS structure through logical URI contract. |
| P3-203 | Add GeoServer execution adapter | Planned | ADR-0009, ADR-0017 | Engine creates or validates workspace/store references through adapter. |
...
| P3-205 | Add document repository execution adapter | Planned | ADR-0007, ADR-0017 | Engine creates or validates project document structure. |

## Milestone P3.3: Governance Hardening

| ID | Item | Status | ADR | Acceptance Criteria |
| --- | --- | --- | --- | --- |
| P3-301 | Add dry-run endpoint | Planned | ADR-0003, ADR-0017 | API returns planned steps without state changes. |
